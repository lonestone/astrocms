    ...
    <>
      ...
      <div
        className={`pointer-events-auto transition-all duration-200 ${
          focused
            ? 'fixed left-1/2 top-16 -translate-x-1/2 w-[min(720px,calc(100%-2rem))] z-40 shadow-2xl'
      ...
      >
        <div
          className={`flex items-start gap-2 rounded-xl border bg-white transition-all ${
            focused
              ? 'border-primary ring-4 ring-primary/15 px-4 py-3'
              : 'border-border px-3 py-1.5 hover:border-gray-400'
          }`}
        >
