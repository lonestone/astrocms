...
| Light | Dark |
| :---: | :---: |
| ![Editing a blog post in AstroCMS, light theme](https://raw.githubusercontent.com/lonestone/astrocms/main/docs/screenshots/editor-light.png) | ![Editing a blog post in AstroCMS, dark theme](https://raw.githubusercontent.com/lonestone/astrocms/main/docs/screenshots/editor-dark.png) |

Asking the built-in Claude Code agent for a new post, with every tool call visible as it works.

| Light | Dark |
| :---: | :---: |
| ![The AstroCMS agent panel writing a blog post, light theme](https://raw.githubusercontent.com/lonestone/astrocms/main/docs/screenshots/agent-light.png) | ![The AstroCMS agent panel writing a blog post, dark theme](https://raw.githubusercontent.com/lonestone/astrocms/main/docs/screenshots/agent-dark.png) |
